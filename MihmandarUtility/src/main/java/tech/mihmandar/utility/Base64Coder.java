 ...
 * 
 */
package tech.mihmandar.utility;
...
public class Base64Coder {
    ...
    public static byte[] decode(char[] in, int iOff, int iLen) {
        if (iLen % 4 != 0) {
			throw new IllegalArgumentException(ErrorEnums.LENGTH_OF_BASE64_ENCODED_INPUT_STRING_IS_NOT_A_MULTIPLE_OF_4.toString());
        }
        ...
        while (ip < iEnd) {
            ...
            if (i0 > 127 || i1 > 127 || i2 > 127 || i3 > 127) {
				throw new IllegalArgumentException(ErrorEnums.ILLEGAL_CHARACTER_IN_BASE64_ENCODED_DATA.toString());
            }
            int b0 = map2[i0];
            int b1 = map2[i1];
            int b2 = map2[i2];
